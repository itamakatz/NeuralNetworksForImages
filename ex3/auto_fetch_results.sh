...
do
    ...
    sshpass -p aso1076a rsync -a --progress -u --prune-empty-dirs samsona@urim.md.biu.ac.il:/home/samson-vol/samsona/itamar/NeuralNetworksImages/ex3/Results/ ./Results/
    rsync -a --progress -u --prune-empty-dirs  ./Results/ /media/itamar/Win-Linux/Results/ex3/
    dt=$(date '+%H:%M:%S');
    echo
